...
<body>
    ...
    %>
    Admin:  <%=session.getAttribute("user_type")%>
    <a href='logout.jsp'>Log out</a>
    <%
    }else{
        %>
        You are not authorized as admin, please <a href="bookstore.jsp">click here</a> to redirect to user dashboard!
    <%
    }
    %>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong><span class=" label label-info"><%= session.getAttribute("full_name") %></span></strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                                </div>
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div><strong><%= session.getAttribute("full_name") %></strong></div>
                    ...
                    <li>
                        <a href="bookdetails.jsp"><i class="fa fa-table fa-fw"></i>Book Details</a>
                    </li>
                    <li>
                        <a href="basicUserManagement.jsp"><i class="fa fa-edit fa-fw"></i>User Management</a>
                    </li>
                    <li>
